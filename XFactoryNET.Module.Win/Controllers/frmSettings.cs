...
namespace XFactoryNET.Module.Win
{
    public partial class frmSettings : Form
    {
        ...
        public static string GetConnectionString()
        {
            ...
            if (settings.SQLAuth)
                return DevExpress.Xpo.DB.MSSqlConnectionProvider.GetConnectionString(settings.Server, settings.UserID, settings.Password, settings.Database);
            else
                return DevExpress.Xpo.DB.MSSqlConnectionProvider.GetConnectionString(settings.Server, settings.Database);
