...
namespace XFactoryNET.Web
{
    ...
    public partial class XFactoryNETAspNetApplication : WebApplication
    { // http://documentation.devexpress.com/#Xaf/DevExpressExpressAppWebWebApplicationMembersTopicAll
        ...
        private XFactoryNET.Module.Web.XFactoryNETAspNetModule module4;
        ...
        public XFactoryNETAspNetApplication()
        {
            InitializeComponent();
        }
        ...
        private void XFactoryNETAspNetApplication_DatabaseVersionMismatch(object sender, DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs e)
        {
#if EASYTEST
			e.Updater.Update();
			e.Handled = true;
        ...
        private void InitializeComponent()
        {
            ...
            this.module4 = new XFactoryNET.Module.Web.XFactoryNETAspNetModule();
    ...
    "FactoryNET";
            ...
            this.DatabaseVersionMismatch += new System.EventHandler<DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs>(this.XFactoryNETAspNetApplication_DatabaseVersionMismatch);
